...
FEE_TIERS: list[tuple[int, Optional[int], int | str]] = [
    (0,        5_000,   100),       # 0 - 5 000        => 100 XOF
    (5_001,    10_000,  300),       # 5 001 - 10 000   => 300 XOF
    (10_001,   25_000,  600),       # 10 001 - 25 000  => 600 XOF
    (25_001,   50_000,  900),       # 25 001 - 50 000  => 900 XOF
    (50_001,   100_000, 1_200),     # 50 001 - 100 000 => 1 200 XOF
    (100_001,  250_000, 2_000),     # 100 001 - 250 000=> 2 000 XOF
    (250_001,  None,    "0.8%"),    # > 250 000        => 0,8 % du montant
]
